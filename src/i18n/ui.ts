...
export const ui = {
  fr: {
    ...
    lPoolBipBefore: 'Avant la baignade : appliquez l\'aimant 3 secondes sur le boîtier (posé sur la margelle) → 1 bip, l\'alarme se met en veille. Si personne n\'entre dans l\'eau sous 2 min, elle se réarme seule.',
    lPoolBipAfter: 'En sortant de l\'eau : réappliquez l\'aimant 3 secondes → 2 bips, ou laissez-la se réarmer seule après ~4 min d\'eau calme.',
  ...
  en: {
    ...
    lPoolBipBefore: 'Before swimming: hold the magnet on the unit (mounted on the pool edge) for 3 seconds → 1 beep, the alarm goes to standby. If no one enters the water within 2 min, it re-arms by itself.',
    lPoolBipAfter: 'When you get out: hold the magnet for 3 seconds again → 2 beeps, or let it re-arm by itself after about 4 min of calm water.',
